...
import com.example.mockodsvue.model.dto.AggregateRequestDTO;
...
public class BranchPurchaseController {
     ...
     */
    @GetMapping("/summary")
    public ResponseEntity<BranchPurchaseSummaryDTO> getSummary(
     ...
     */
    @PutMapping("/summary")
    public ResponseEntity<BranchPurchaseSummaryDTO> updateConfirmedQty(
            @RequestBody BranchPurchaseSummaryUpdateDTO dto,
     ...
     */
    @PostMapping("/freeze")
    public ResponseEntity<BranchPurchaseSummaryDTO> freeze(
            @RequestBody BranchPurchaseFreezeDTO dto,
            @AuthenticationPrincipal UserDetails userDetails) {
        String currentUser = userDetails.getUsername();
    ...
    public ResponseEntity<BranchPurchaseSummaryDTO> unfreeze(
            @RequestBody BranchPurchaseFreezeDTO dto,
            @AuthenticationPrincipal UserDetails userDetails) {
        String currentUser = userDetails.getUsername();
     ...
     */
    @PostMapping("/confirm")
    public ResponseEntity<BranchPurchaseSummaryDTO> confirm(
            @RequestBody BranchPurchaseFreezeDTO dto,
            @AuthenticationPrincipal UserDetails userDetails) {
        String currentUser = userDetails.getUsername();
    ...
    public ResponseEntity<List<BranchPurchaseOrderDTO>> aggregate(
            @RequestBody AggregateRequestDTO dto,
            @AuthenticationPrincipal UserDetails userDetails) {
        String currentUser = userDetails.getUsername();
        List<BranchPurchaseOrderDTO> result = branchPurchaseService.aggregate(
                dto.getBranchCode(), dto.getPurchaseDate(), currentUser);
        return ResponseEntity.ok(result);
    }
     ...
     */
    @GetMapping("/bpo")
    public ResponseEntity<List<BranchPurchaseOrderDTO>> getBpoList(
            @RequestParam String branchCode,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
