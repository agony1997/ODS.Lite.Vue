...
import com.example.mockodsvue.purchase.mapper.BranchPurchaseMapper;
...
import com.example.mockodsvue.purchase.model.dto.BranchPurchaseSummaryDTO.SummaryDetailDTO;
...
import com.example.mockodsvue.master.repository.ProductFactoryRepository;
import com.example.mockodsvue.purchase.repository.BranchPurchaseFrozenRepository;
import com.example.mockodsvue.purchase.repository.BranchPurchaseOrderDetailRepository;
import com.example.mockodsvue.purchase.repository.BranchPurchaseOrderRepository;
...
public class BranchPurchaseService {
    ...
    public BranchPurchaseSummaryDTO freeze(BranchPurchaseFreezeDTO dto, String currentUser) {
        ...
        // 建立凍結記錄
        BranchPurchaseFrozen bpf = BranchPurchaseFrozen.createFrozen(branchCode, purchaseDate, currentUser);
